...
//        subscriberIterators.add(eventSubscribers.iterator());
        ...
        allSubscribers.addAll(eventSubscribers);
      }
    }

    Collections.sort(allSubscribers, Subscriber.COMPARATOR);
...
//
  ...
  private Multimap<Class<?>, Subscriber> findAllSubscribers(Object listener) {
    ...
    for (Method method : getAnnotatedMethods(clazz)) {
      ...
      methodsInListener.put(eventType, Subscriber.create(bus, listener, method, annotation.priority(), annotation.ignoreCancelled()));
    }
