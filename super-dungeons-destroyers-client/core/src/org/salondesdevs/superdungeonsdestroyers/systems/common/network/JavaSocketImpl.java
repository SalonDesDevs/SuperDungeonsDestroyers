 ...
 * @author noblemaster
 */
public class JavaSocketImpl implements Socket {
    ...
    public JavaSocketImpl(Protocol protocol, String host, int port, SocketHints hints) {
        try {
            // create the socket
    ...
    public JavaSocketImpl(java.net.Socket socket, SocketHints hints) {
        this.socket = socket;
        applyHints(hints);
    }
