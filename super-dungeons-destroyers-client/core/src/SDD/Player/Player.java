...
public final class Player extends Table {
  ...
  public SDD.Player.Vec3 location() { return location(new SDD.Player.Vec3()); }
  public SDD.Player.Vec3 location(SDD.Player.Vec3 obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
