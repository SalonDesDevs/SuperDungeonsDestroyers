...
public final class Messages extends Table {
  ...
  public SDD.Client.Message messages(int j) { return messages(new SDD.Client.Message(), j); }
  public SDD.Client.Message messages(SDD.Client.Message obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
