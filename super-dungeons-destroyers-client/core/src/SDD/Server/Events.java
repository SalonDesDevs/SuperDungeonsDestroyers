...
public final class Events extends Table {
  ...
  public SDD.Server.Event events(int j) { return events(new SDD.Server.Event(), j); }
  public SDD.Server.Event events(SDD.Server.Event obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
