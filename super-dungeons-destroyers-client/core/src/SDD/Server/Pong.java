...
public final class Pong extends Table {
    ...
    public static Pong getRootAsPong(ByteBuffer _bb) {
        return getRootAsPong(_bb, new Pong());
    }

    public static Pong getRootAsPong(ByteBuffer _bb, Pong obj) {
    ...
    public Pong __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startPong(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
